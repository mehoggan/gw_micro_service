...
#ifndef WARSCROLL_COLLECTOR_H
#define WARSCROLL_COLLECTOR_H
...
// *location: warscroll_collector
class warscroll_collector: public ngrest::Service
{
public:
    // Here is an example of service operation
    //! Dummy description for the operation
    /*! Some detailed description of the operation */
    // To invoke this operation from browser open: http://localhost:9098/warscroll_collector/World!
    //
    // '*location' metacomment sets path to operation relative to service operation.
    // Default value is operation name.
    // This will bind "echo" method to resource path: http://host:port/warscroll_collector/{text}
    // *location: /{text}
    //
