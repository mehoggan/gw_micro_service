...
public:
    ...
    // To invoke this operation from browser open: http://localhost:9098/calculator/World!
    //
    // '*location' metacomment sets path to operation relative to service operation.
    // Default value is operation name.
    // This will bind "echo" method to resource path: http://host:port/calculator/{text}
    // *location: /{text}
    //
